...
const DashBoard = () => {
  ...
  const { totalUsers, usersJoined, totalTrips, tripsCrated, userRole } = dashboardStats;
      ...
      <section className="flex flex-col gap-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          <StatsCard
            ...
            total={totalTrips}
            currentMonthCount={tripsCrated.currentMonth}
            lastMonthCount={tripsCrated.lastMonth} 
          />
